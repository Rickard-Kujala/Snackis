...
namespace Snackis.Pages
{
    ...
    {
        private readonly ILogger<ForumViewModel> _logger;
        ...
        public ForumViewModel(ILogger<ForumViewModel> logger, UserManager<SnackisUser> userManager,
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var id = Request.Cookies["MyForumCookie"];
            if (Request.Cookies["MyForumCookie"] != null)
            {
